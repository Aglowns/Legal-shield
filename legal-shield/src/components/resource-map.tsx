import { ExternalLink, Landmark, Phone, Scale } from "lucide-react";
...
export function ResourceMap({ resources, loading, category }: ResourceMapProps) {
  return (
    <section className="rounded-2xl border border-blue-100 bg-white p-5 shadow-sm md:p-6">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        {resources.map((resource) => (
          <article key={resource.id} className="rounded-xl border border-blue-100 p-4">
